...
- (void)viewDidLoad
{
    ...
    [annotation setTitle:self.parkName]; //You can set the subtitle too
    NSMutableArray *annotations = [[NSMutableArray alloc] init];
    [annotations addObject:annotation];
    [self.ParkMapView addAnnotations:annotations];
    
    [self.ParkMapView showAnnotations:annotations animated:YES];
